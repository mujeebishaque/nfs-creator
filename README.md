...
```
cd existing_repo
git remote add origin https://gitlab.com/progressivesystems/wimex-nfs.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/progressivesystems/wimex-nfs/-/settings/integrations)
